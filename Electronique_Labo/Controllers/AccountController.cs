...
namespace Electronique_Labo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(ViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Invalid login attempt."); ViewBag.err = 330;
                    ViewBag.err = 330;
                    return View(model);
            }
        }
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Register(ViewModel model)
        {
            if (!ModelState.IsValid)
            {
                ViewBag.err = 340;
